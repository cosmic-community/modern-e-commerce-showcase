...
export const metadata: Metadata = {
  title: 'Contact Us | Modern E-Commerce Showcase',
  description: 'Get in touch with us. We\'d love to hear from you about our products, services, or any questions you may have.',
}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <a 
                  href="mailto:hello@ecommerce-showcase.com" 
          ...
          <div className="bg-secondary bg-opacity-10 rounded-lg p-8 mt-6">
            <h3 className="font-semibold text-lg text-primary mb-3">Why Contact Us?</h3>
